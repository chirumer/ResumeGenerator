...
interface WorkExperienceCategoryFilterBarProps {
...
export function WorkExperienceCategoryFilterBar({
  allCategories,
  selectedCategories,
  onToggleCategory,
  onClearFilters,
...
}: WorkExperienceCategoryFilterBarProps) {
  ...
  const handleArchiveFilterChange = (filter: WorkExperienceArchiveFilter) => {
  ...
  return (
    <div className="flex flex-col gap-3 h-14 px-4 py-2 border-b bg-muted/30">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 shrink-0 ml-4">
          <span className="text-sm text-muted-foreground whitespace-nowrap">
            Showing {filteredCount} of {totalCount} work experiences
          </span>
          <Button
            variant="outline"
            size="sm"
